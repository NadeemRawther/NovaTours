...
public class UserDetailed extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(UserDetailed.this,user,Toast.LENGTH_LONG).show();
        Bundle bundle = new Bundle();
        bundle.putString("userids",user);
        userProfileDetails = new UserProfileDetails();
         userProfileDetails.setArguments(bundle);
         userBankDetails = new UserBankDetails();
         userBankDetails.setArguments(bundle);
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_user_detailed, menu);
        return true;
    }
